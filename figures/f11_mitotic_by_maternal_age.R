...
ylab("Prop. with Mitotic Error") + theme(legend.position = "right") + theme_bw() + scale_color_discrete(name = "")
...
summary(glm(data = mitotic_blastomere, formula = cbind(euploid, aneuploid) ~ maternal_age, 
family = quasibinomial(link = "logit")))
summary(glm(data = mitotic_te, formula = cbind(euploid, aneuploid) ~ maternal_age, 
family = quasibinomial(link = "logit")))
